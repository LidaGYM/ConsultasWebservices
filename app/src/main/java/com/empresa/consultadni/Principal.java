                ...
                if (!TextUtils.isEmpty(txt_search.getText().toString() )){
                    if (sqlite.tb_personas().find(txt_search.getText().toString())==null){
                        if (NetworkUtils.isConnected()){
                                            ...
                                            if (statusCode == 200){
                                                try {
                                                    ...
                                                    if (!TextUtils.isEmpty((new String(responseBody)) ) ){
                                                        ...
                                                        if (persona!=null){
                                                            //Utils.function.showToastSuccess("Se encontró DNI");
                                                            ...
                                                            Utils.function.showToastError("No hubo resultados");
                                                        }
                                                    }
                                                }catch (Exception ex){
                                                    ex.printStackTrace();
                            ...
                            Utils.function.showToastError("No está conectado a Internet.");
                        }
                    }else{
        ...
        try{
            ...
            if (jsonObject.getString("success").equals("true")){
                ...
                Personas.tb persona= new Personas.tb(
                        //Datos tomados del JSON que da la API
            ...
            if (persona!=null){
                ...
                ly_result.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ly_result.addView(build_item("Ap. Paterno",persona.getAp_paterno() ) );
                        ly_result.addView(build_item("Ap. Materno",persona.getAp_materno() ) );
                        ly_result.addView(build_item("Fecha Nacimiento",persona.getNacimiento() ) );
